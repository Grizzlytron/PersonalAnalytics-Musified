...
PersonalAnalytics (Musified) is not open source and may not be commercially used for any purpose. Please contact Lucas Baer (lucastimothyleo.baer@uzh.ch) if you have any questions regarding this aspect.
...
## 📨 Contact
- You may contact Lucas Baer (lucastimothyleo.baer@uzh.ch) in case of questions on the project.
...
## ↪️ Dependencies
This project uses [PA.WindowsActivityTracker](https://github.com/HASEL-UZH/PA.WindowsActivityTracker) and [PA.UserInputTracker](https://github.com/HASEL-UZH/PA.UserInputTracker/) as its main data trackers. The Muse Tracker is implemented privately and not open source as it uses InteraXon's Software Development Kit which is not freely publicly accessible. 
